...
func _ability_golden() -> Dictionary:
	return {
		...
		"boss_nemesis_synthetic": "280 AP dmg (all enemies)",
...
func _pre_change_ability_descriptions() -> Dictionary:
	return {
		...
		"boss_nemesis_synthetic": "Unleashes a catastrophic singularity burst dealing 280 AP damage across all enemies.",
